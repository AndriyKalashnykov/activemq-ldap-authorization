...
docker exec -it $ACTIVEMQ_CONTAINER /opt/apache-activemq-5.16.1/bin/activemq producer --user admin --password admin --destination ADMINS.TEST --message hello --messageCount 1
docker exec -it $ACTIVEMQ_CONTAINER /opt/apache-activemq-5.16.1/bin/activemq producer --user user --password admin --destination ADMINS.TEST --message hello --messageCount 1
